...
class RoundingDecimalNumbers 
{
    public static void main(String args[])
    {
        ...
        double roundedToOneDecimalPlace = Math.round(decimalNo * 10.0)/10.0;
        double roundedToTwoDecimalPlace = Math.round(decimalNo * 100.0)/100.0;
        double roundedToThreeDecimalPlace = Math.round(decimalNo * 1000.0)/1000.0;
